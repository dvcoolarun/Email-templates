...
You must do this because some clients, such as Gmail, will ignore your style tag contents.**
	Premailer :- can be used to bring css inline(if tool is used remember to take out your media queries before processing than reinsert), You must do this because some clients, such as Gmail, will ignore your style tag contents.**
